...
"Seedup"이란 회사가 고객에 대하여 증권매매거래 기타 서비스를 제공함에 있어서 이용하는 스마트폰 어플리케이션을 의미하며, "토스증권탭"이란 회사가 고객에 대하여 증권매매거래 기타 서비스를 제공함에 있어서 이용하는 화면으로서 고객이 토스앱을 통하여 진입할 수 있는 것을 의미합니다.
